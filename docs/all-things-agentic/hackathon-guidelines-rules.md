...
Aug 31, 2026 @ 5:00pm PDT 
Online
Public
$180,000 in cash	6259 participants
Google
...
$150 in Google Cloud credits for this hackathon — request via the credit form.

 
GET HELP
Join the Devpost Discord to ask peers or get help from the community.

Post on the Discussion Forum.

Still Stuck after this page? The FAQs cover credits, required tech and questions about submissions.
...
Persistence is not memory, climb the whole hierarchy, from a forgetful goldfish to managed cloud memory.
...
How do I sign up? Sign in to your Google Developer Program profile and claim the GEAR badge.
...
Where do I begin? Start with the Introduction to Agents path, then move on to the Build and Deploy paths.

Questions? The GEAR FAQ covers the details.
